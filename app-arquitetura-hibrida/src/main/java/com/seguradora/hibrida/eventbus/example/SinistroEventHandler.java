...
/**
 * Handler de exemplo para eventos de sinistro.
 * 
 * <p>Este handler demonstra como implementar processamento de eventos
 * de domínio com diferentes estratégias baseadas no tipo de evento.
 * 
