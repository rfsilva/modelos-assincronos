package com.seguradora.hibrida.query.config;
...
/**
 * Configuração de cache para o Query Side do CQRS.
 * 
 * <p>Configura cache Redis com diferentes TTLs para diferentes
 * tipos de consultas, otimizando a performance do Query Side.
 */
@Configuration
@EnableCaching
...
public class QueryCacheConfiguration {
    ...
    /**
     * Configura o CacheManager para consultas.
     */
